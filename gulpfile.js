...
const watcher = done => {
  ...
  watch(paths.watch.css).on('change', function(){setTimeout( series(tasks.css, browserSync.reload), 100)});  watch(paths.watch.js).on('change', series(tasks.scripts, browserSync.reload));
